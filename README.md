...
In this hands-on workshop, learn how to make decisions from machine learning models that are fair and explainable, and evaluate the health of your models once they are deployed. You learn to assess models for unintended bias with Fairness and Bias statistics in Model Studio. Then you learn to assess the health of a deployed model using Model Cards.
